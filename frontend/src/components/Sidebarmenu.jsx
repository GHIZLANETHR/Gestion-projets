            ...
            <div className="hidden md:flex md:w-64 md:flex-col">
                <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-white">
                    <div className="flex items-center flex-shrink-0 px-4">
                        <Link to="/HomePage">
                            <div className="font-bold text-4xl text-[#d22c6e]">
                                T<span className="text-[#9c28b1]">askify</span>
                            </div>
                        </Link>
                    </div>
                        ...
                        <div className="space-y-4">
                            <nav className="flex-1 space-y-2">
                                <div className={`flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg group ${
                                    ...
                                    <Link to="/Admindash" className="w-full">Tableau de bord</Link>
                                </div>
                                ...
                                <div className={`flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg group ${
                                    ...
                                    <Link to="/Customers" className="w-full">Clients</Link>
                                </div>
                                ...
                                <div className={`flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg group ${
                                    ...
                                    <Link to="/Employees" className="w-full">Employés</Link>
                                </div>
                                ...
                                <div className={`flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg group ${
                                    ...
                                    <Link to="/Projects" className="w-full">Projets</Link>
                                </div>
                            </nav>
                            ...
                            <nav className="flex-1 space-y-2">
                                <div className={`flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg group ${
                                    ...
                                    <Link to="/Tasks" className="w-full">Tâches</Link>
                                </div>
                                ...
                                <div className={`flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg group ${
                                    ...
                                    <Link to="/Invoices" className="w-full">Factures</Link>
                                </div>
                            </nav>
